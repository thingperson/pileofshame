# Session Resume — 2026-05-07 (Wednesday morning, PDT)

**START HERE.** Landing page V2 redesign session. 9 commits on `landing-v2` branch. Nothing merged to main yet — Brady is sitting on it pending visual review of the Vercel preview.
...
9. **Major copy overhaul:**
   ...
   - Banner: "Skip the form. Just tap a vibe."
...
- **Pip sprites** at `public/landing/pip-wave.png` and `public/landing/pip-guide.png` (400px max dimension PNGs)
...
*Updated: 2026-05-07 ~11:00 AM PDT*
