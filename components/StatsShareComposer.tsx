...
const PILE_FLAVORS = [
  ...
  (_: number, cleared: number) => cleared > 20 ? `${cleared} games cleared. The pile is scared.` : `Making progress, one game at a time.`,
  (_: number, cleared: number) => cleared > 0 ? `${cleared} cleared. Every one counts.` : `The pile trembles. It knows what's coming.`,
