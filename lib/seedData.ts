...
export const SEED_GAMES: Game[] = [
  ...
  // Backlog — enriched
  {
    ...
    description: 'An open-world RPG about being a cop in a city on the brink. Question suspects, explore, or just get hammered.',
    hltbMain: 30,
    hltbComplete: 53,
    enrichedAt: now,
    addedAt: daysAgo(365),
  ...
  // PlayStation game
  {
    ...
    status: 'buried',
    moodTags: ['intense', 'story-rich'],
    description: 'Kratos and Atreus set out on a mythic quest for answers before the prophesied Ragnarok arrives.',
    hltbMain: 26,
    hltbComplete: 53,
    enrichedAt: now,
    addedAt: daysAgo(180),
