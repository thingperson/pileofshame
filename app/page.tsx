...
import { REROLL_ICONS, MOOD_ICONS } from '@/lib/iconMap';
    ...
    <div className="relative z-10 w-full max-w-[960px] mx-auto px-4 py-6 pb-24">
      ...
      <div className="mb-3 space-y-2">
          ...
          <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-1 -mx-1 px-1 scrollbar-hide">
            ...
            >
              <CustomIcon src={REROLL_ICONS['quick-session']} fallback="🌙" size={28} /> Quick Session
            </button>
            <button
            ...
            >
              <CustomIcon src={REROLL_ICONS['deep-cut']} fallback="🔥" size={28} /> Deep Cut
            </button>
            <button
            ...
            >
              <CustomIcon src={REROLL_ICONS['continue']} fallback="▶" size={28} /> Keep Playing
            </button>
